...
if(isset($_SESSION['username']))
{
  ...
  if (isset($_POST['submit'])){
    ...
    $final_password = password_hash($new_pass,PASSWORD_BCRYPT);

    $check120 = "SELECT * FROM account WHERE username = '$username'";
    $result120 = mysqli_query($conn, $check120);
    $row120 = mysqli_fetch_array($result120);
    if(mysqli_num_rows($result120)==1)
    {
      $pass_sq=$row120['acc_password'];
      if(password_verify($old_pass,$pass_sq))
      {
        if($new_pass == $re_pass){
            $sql32 = "UPDATE account 
            SET acc_password='$final_password' 
            WHERE ID=  $id_user ";  
            $result32 = mysqli_query($conn, $sql32);                         
        }
        else{
          echo "<script> 
          alert('Re-enter password not true! Try again...');
          </script>";
        }
      }else{
        echo "<script> 
      ...
      echo "<script> 
      alert('Unknown Problem ! Try again...');
      </script>";
    }
  }
  ///-------------------------------------------------------------------------
        ...
        <div class="col-md-8">
          <div class="card mb-3" style="border-radius: 20px;">
            <div class="card-body">
              <div class="row">
                <div class="col-sm-3">
                  <h6 class="mb-0" style="font-family: 'Mukta', sans-serif; font-family: 'Poppins', sans-serif; font-weight:bold;">ID Staff</h6>
                </div>
              ...
              <div class="row">
                <div class="col-sm-3">
                  <h6 class="mb-0" style="font-family: 'Mukta', sans-serif; font-family: 'Poppins', sans-serif; font-weight:bold;">Fisrt Name</h6>
                </div>
              ...
              <div class="row">
                <div class="col-sm-3">
                  <h6 class="mb-0" style="font-family: 'Mukta', sans-serif; font-family: 'Poppins', sans-serif; font-weight:bold;">Last Name</h6>
                </div>
              ...
              <div class="row">
                <div class="col-sm-3">
                  <h6 class="mb-0" style="font-family: 'Mukta', sans-serif; font-family: 'Poppins', sans-serif; font-weight:bold;">Username</h6>
                </div>
              ...
              <div class="row">
                <div class="col-sm-3">
                  <h6 class="mb-0" style="font-family: 'Mukta', sans-serif; font-family: 'Poppins', sans-serif; font-weight:bold;">Position</h6>
                </div>
              ...
              <div class="row">
                <div class="col-sm-3">
                  <h6 class="mb-0" style="font-family: 'Mukta', sans-serif; font-family: 'Poppins', sans-serif; font-weight:bold; font-size:15px;">Department</h6>
                </div>
              ...
              <div class="row">
                <div class="col-sm-3">
                  <h6 class="mb-0" style="font-family: 'Mukta', sans-serif; font-family: 'Poppins', sans-serif; font-weight:bold; font-size:15px;">Level</h6>
                </div>
                <h6 class="col-sm-9 text-secondary" style="border:0; font-family: 'Mukta', sans-serif; font-family: 'Poppins', sans-serif;">Admin</h6>
              </div>
              <hr>
