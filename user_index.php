          ...
          <div class="card mb-3" style="border-radius: 20px;">
            <div class="card-body">
              <div class="row">
                ...
                <h6 class="col-sm-9 text-secondary" style="border:0; "><?=$row['ID'] ?></h6>
              ...
              <div class="row">
                ...
                <h6 class="col-sm-9 text-secondary" style="border:0;"><?=$row['first_name'] ?></h6>
              </div>
              <hr>
              <div class="row">
                <div class="col-sm-3">
                ...
                <h6 class="col-sm-9 text-secondary" style="border:0;"><?=$row['last_name'] ?></h6>
              ...
              <div class="row">
                ...
                <h6 class="col-sm-9 text-secondary" style="border:0;"><?=$row['username'] ?></h6>
              ...
              <div class="row">
                ...
                <h6 class="col-sm-9 text-secondary" style="border:0; "><?=$row['position'] ?></h6>
