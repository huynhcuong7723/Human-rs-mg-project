        ...
        <div id="main">
            ...
            <div class="container2" >
                ...
                <div class="table-responsive table-dark" style="border-radius:20px;">
                        ...
                        $sql5 = "SELECT *
                                    ...
                                    where leave_info.username_id='$store'
                                    ORDER BY leave_info.status ASC, leave_info.leave_date DESC";
                        ...
                        ?>
                                <div class="table-wrapper ">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2">
                                        <a class="btn btn-warning " data-toggle="modal" data-target="#exampleModal"><i class="fa fa-spinner"></i> Waitting</a>
                                        </div>
                                        <div class="col-sm-3">
                                        <a  class="btn btn-success "  data-toggle="modal" data-target="#doneleave"><i class="fa fa-check"></i> Approved Leaves</a>
                                        </div>
            ...
            <div class="modal fade in" id="exampleModal" tabindex="-1" >
                <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        <div class="modal-header bg-dark text-white ">
                            <h4 style="font-weight:bold;" >Waiting Leave</h4>
                        </div>
                        <div class="modal-body">
                            <div>
            ...
            <!-----------------------------------------MODAL STATUS------------------------------>
            <div class="modal fade in" id="doneleave" tabindex="-1" >
                <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        <div class="modal-header bg-dark text-white ">
	...
	if (isset($_POST['apply'])){
        ...
        if($run == true){
			...
			echo "<script> 
					...
					window.open('leave_user.php','_self');
				  </script>";
		}else{
			echo "<script> 
